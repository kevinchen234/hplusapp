				...
				<c:forEach var="product" items="${products}">
					<div class="productContainer">
						...
						<div class="productContainerItem">
							<img id="pic1" src="${product.imagePath}" alt="${product.name}">
		...
		<section id="history" class="section">
			<div class="container">
				<div class="text-content">
					...
					<p>
						Today that vision has become H+ Sport…offering a variety of <a href="#products">supplements, energy bars and
							rehydration
